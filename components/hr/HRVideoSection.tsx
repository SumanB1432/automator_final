...
const VideoSection = () => {
  ...
  return (
    <section className="w-full flex items-center justify-center bg-[#11011E] relative px-4 sm:px-6 lg:px-8 xl:px-20 py-12 sm:py-16 lg:py-24 min-h-[60vh] sm:min-h-[70vh] lg:min-h-[80vh]">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#7000FF] rounded-full animate-pulse"></div>
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-[#FF00C7] rounded-full  animate-pulse delay-1000"></div>
        ...
        <div className="relative w-full h-full">
          {!showVideo ? (
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/x85a0a1utDY?rel=0&autoplay=1"
              title="Demo Video"
              frameBorder="0"
