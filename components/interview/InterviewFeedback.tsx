...
const InterviewFeedback: React.FC<InterviewFeedbackProps> = ({ session }) => {
  ...
  // const { strengths, improvements, overallScore, transcript, recording } = session.feedback;

  const feedback = {
    strengths: ["Good communication", "Strong technical knowledge"], // Placeholder
    improvements: ["Be more concise", "Provide more examples"], // Placeholder
    overallScore: 8, // Placeholder
    transcript: session.transcript,
    recording: session.recordings?.[0], // Use first recording
  };
